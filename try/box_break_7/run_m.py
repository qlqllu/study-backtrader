...
def test_one_stock(stock_id):
  ...
  data = bt.feeds.GenericCSVData(
      dataname=f'{data_folder}hfq/{stock_id}.csv',
      name=stock_id,
      datetime=0,
      open=1,
      high=2,
  ...
  data_dp = bt.feeds.GenericCSVData(
      dataname=f'{data_folder}dp.csv',
      datetime=0,
      open=2,
      high=3,
      low=4,
...
if __name__ == '__main__':
  ...
  files = os.listdir(f'{data_folder}hfq')
  i = 0
  ...
  resultData.to_csv('./box_break_test_result_trades-7.csv')
